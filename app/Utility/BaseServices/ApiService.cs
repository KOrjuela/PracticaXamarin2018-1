namespace COrjuela.Utility.BaseServices
{
    using COrjuela.Utility.BaseEntities;
    using global::Utility.BaseEntities;
    ...
    {
        /// <summary>
        /// Garantizamos conexion a internet
        /// </summary>
        /// <returns></returns>
        public async Task<Response> CheckConnection()
        {
            ///<Validación_1>
            ///Verificamos si está habilitado el servicio de Internet
            ///</Validacion_1>
            ...
            ///<Validación_2>
            ///Verificamos si existe servicio de Internet
            ///</Validacion_2>
        ...
        #region Method
        /// <summary>
        /// Método para el control de excepciones.
        /// </summary>
        /// <param name="ex">Excepción generada</param>
        /// <returns>Excepción controlada por el sistema</returns>
        private Response GetResponse(bool isSuccess, string message, object result)
        {
            return null;
        }
        #endregion
